...
def class_main():
    ...
    valid_labels = classifier.classify_and_copy_folder(DIRECTORY_PATH / "top_segments/", DIRECTORY_PATH / "categorized_top", 0.3)
    classifier.classify_and_copy_folder_with_label_filter(DIRECTORY_PATH / "side_segments/", DIRECTORY_PATH / "categorized_side", valid_labels, 0.3)